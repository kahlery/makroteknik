    ...
    return (
        <div className="text-black mb-12 mt-4 sm:mt-12 lg:mx-64">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 sm:gap-4 text-[0.7rem] sm:text-sm px-6 md:px-0" style={{ color: '#f2f2f2' }} >
                <div className="bg-white p-4 text-start shadow border">
                ...
                <button className="mx-2 text-sm text-secondary border py-2 mt-4 rounded-lg transition-colors duration-500 col-span-full hover:bg-secondary">
                    List All News
                </button>
            </div >
        </div>
