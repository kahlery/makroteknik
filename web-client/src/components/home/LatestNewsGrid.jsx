...
const LatestNewsGrid = () => {
    return (
        <div className="text-black mb-12 mt-14 sm:mt-14 mx-6 lg:mx-64 justify-items-center h-full flex-col my-auto">
            ...
            <button className="text-base text-secondary pt-2 mt-6">
                View All News
            </button>
        </div>
    );
