...
const InNavigation = ({ itemsList, isSearchActive }) => {
    return (
        <div className="flex flex-col md:flex-row text-center md:text-end">
            <div className="bg-opacity-80 bg-primary backdrop-blur-sm px-4 w-screen hidden md:block md:w-[22rem] h-screen text-white fixed top-[122.3px] pb-[330px] z-50 overflow-y-scroll">
