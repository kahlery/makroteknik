...
const InNavigation = ({ itemsList }) => {
    return (
        <div className="flex flex-col md:flex-row text-center md:text-end">
            <div className="bg-opacity-80 bg-primary backdrop-blur-sm px-4 border-r-2 border-primary w-96 h-screen text-white fixed top-[122.3px] pb-[330px] pt-4 z-40 overflow-y-scroll">
