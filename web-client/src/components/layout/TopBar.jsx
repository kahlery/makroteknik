...
const TopBar = () => {
    ...
    return (
        <div className="flex flex-row bg-white text-black py-2 px-2 lg:px-64 top-0 text-sx w-full fixed z-[1000] border-b">
            ...
            <div className="ml-4 flex flex-row items-center w-full">
                ...
                <button className="flex ml-auto border-white border-2 p-2 text-xs shadow-md rounded-full text-black">Get An Offer</button>
            </div>
        </div>
    );
};
