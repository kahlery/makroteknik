...
const TopBar = () => {
    return (
        <div className="bg-black shadow-inner text-secondary py-2 px-6 lg:px-64 top-0 text-sx w-full fixed z-50">
            <div className="mx-auto flex flex-row justify-between items-center">
                ...
                <button className="border-2 border-secondary p-2 text-xs shadow-lg text-white">Get An Offer</button>
            </div>
        </div>
    );
};
