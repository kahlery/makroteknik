...
const TopBar = () => {
    ...
    return (
        <div className="flex flex-row bg-white text-black py-2 px-2 lg:px-64 top-0 text-sx w-full fixed z-[1000]
         shadow">
            ...
            <div className="ml-4 flex flex-row items-center w-full">
                ...
                <button className="flex ml-auto border-black border-2 p-2 text-xs shadow-black text-black">Get An Offer</button>
            </div>
        </div>
    );
};
