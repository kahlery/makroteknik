...
const NavBar = () => {
    ...
    return (
        ...
        justify-center md:justify-between  w-full fixed bottom-0 sm:top-[40px] z-40 text-center md:border-b border-t
         md:border-t-0 border-black border-opacity-20 shadow-md"
            onClick={() => {
                // scroll to top
