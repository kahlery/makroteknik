...
const TopBar = () => {
    ...
    return (
        <div className="flex border-b border-black border-opacity-20 flex-row bg-neutral-200 text-black py-[8px] px-2 md:px-[16rem] 2xl:px-[25rem] top-0 text-sx w-full fixed z-[1000]">
