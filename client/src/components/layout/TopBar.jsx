...
const TopBar = () => {
    ...
    return (
        <div className="flex flex-row bg-secondary text-white py-[8px] px-2 md:px-[16rem] 2xl:px-[25rem] top-0 text-sx w-full fixed z-[1000]">
            <div className="ml-4 flex flex-row items-center w-full">
                ...
                <button className="flex ml-auto border-white border px-3 py-1 text-xs shadow-md text-white">
                    Get An Offer
                </button>
            </div>
        </div>
